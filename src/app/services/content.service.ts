...
// This service is a centralized API communication layer that talks to the backend to manage Media, Tasks, Programs, Modules, Ratings, Classrooms, and related data.
export class ContentService {
  ...
  getMediaTypes(): Observable<IMediaType[]> {
    return this.http.get<IMediaType[]>('/api/MediaCues/MediaTypes').pipe(
  ...
  getDefaultBackForwardAlternateStepImageIds(): Observable<IDefaultBackForwardAlternateStepImageIds> {
    return this.http
      .get<IDefaultBackForwardAlternateStepImageIds>(
        '/api/MediaCues/DefaultBackForwardAlternateStepImageIds',
      )
      .pipe(
        tap((_) =>
          this.log(
            'fetched Default Back, Forward and Alternate Next Step Image Ids',
          ),
        ),
        catchError(
          this.handleError<IDefaultBackForwardAlternateStepImageIds>(
            'getDefaultBackForwardAlternateStepImageIds',
          ),
        ),
      );
  }
  ...
  getMediaCues(): Observable<IMediaCueRow[]> {
    return this.http.get<IMediaCueRow[]>('/api/MediaCues').pipe(
  ...
  getMediaCuesByOrganizationId(orgId: number): Observable<IMediaCueRow[]> {
    return this.http
      .get<IMediaCueRow[]>('/api/MediaCues/byOrganizationId/' + orgId)
      .pipe(
        map((response) =>
          response.map((item) => ({
            ...item,
            displayTagCount: this.helpers.getStringArrayDisplayLimit(
              item.mediaTags,
              this.sizeLimit,
            ),
          })),
        ...
        catchError(
          this.handleError<IMediaCueRow[]>('getMediaCuesByOrganizationId', []),
        ),
      );
  }

  getMediaCuesByOrganizationIdIncludeNotShared(
    orgId: number,
  ): Observable<IMediaCueRow[]> {
    return this.http
      .get<
        IMediaCueRow[]
      >('/api/MediaCues/MediaCuesByOrganizationIdIncludeNotShared/' + orgId)
      .pipe(
        map((response) =>
          response.map((item) => ({
            ...item,
        ...
        tap((_) =>
          this.log('fetched AllMediaCuesfor OrgId ' + orgId.toString()),
        ),
        catchError(
          this.handleError<IMediaCueRow[]>(
            'getMediaCuesByOrganizationIdIncludeNotShared',
            [],
          ),
        ),
  ...
  getSharedMediaCuesByOrganizationId(
    orgId: number,
  ): Observable<IMediaCueRow[]> {
    return this.http
      .get<
        IMediaCueRow[]
      >('/api/MediaCues/SharedMediaCuesbyOrganizationId/' + orgId)
      .pipe(
        map((response) =>
          response.map((item) => ({
            ...item,
  ...
  mediaCueSharedChange(id: number, shared: boolean): Observable<any> {
    ...
    return this.http
      .put<IMediaCueShareRow>(
        '/api/MediaCues/SharedMediaCuesUpdate/' + id + '/' + shared,
        { headers },
      )
      .pipe(
        tap((_) => this.log(`SharedMediaCuesUpdate id=${id}`)),
        catchError(
          this.handleError<IMediaCueShareRow>(`mediaCueSharedChange id=${id}`),
        ),
      );
  }

  getMediaCuesByOptions(
    options: IMediaCueSearchOptions,
    orgId: number,
  ): Observable<IMediaCueRow[]> {
    if (!options.ModuleId) {
      options.ModuleId = 0;
    ...
    return this.http
      .get<IMediaCueRow[]>('/api/MediaCues/MediaCueSearchOptions/' + orgId, {
        params: httpParams,
      })
      .pipe(
        tap((_) => this.log('fetched MediaCuesByOptions')),
        catchError(
          this.handleError<IMediaCueRow[]>('getMediaCuesByOptions', []),
        ),
      );
  }
  ...
  getMediaCuesByType(
    ...
    return this.http
      .get<IMediaCueRow[]>('/api/MediaCues/MediaCuesByType/' + orgId, {
        params: httpParams,
      })
      .pipe(
        tap((_) => this.log('fetched MediaCuesByOptions')),
  ...
  getMediaCue(id: number): Observable<IMediaCue> {
    return this.http.get<IMediaCue>('/api/MediaCues/' + id).pipe(
  ...
  getMediaCueDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/MediaCues/Dependencies/' + id).pipe(
  ...
  deleteMediaCue(id: number): Observable<any> {
    return this.http.delete<IMediaCue>('/api/MediaCues/' + id).pipe(
  ...
  saveMediaCue(mediaCue: IMediaCue): Observable<IMediaCue> {
    ...
    if (mediaCue.id > 0) {
      return this.http
        .put<IMediaCue>('/api/MediaCues/' + mediaCue.id, mediaCue, { headers })
        .pipe(
          tap((_) => this.log(`put MediaCue id=${mediaCue.id}`)),
          catchError(
            this.handleError<IMediaCue>(`saveMediaCue id=${mediaCue.id}`),
          ),
        );
    } else {
      return this.http
        .post<IMediaCue>('/api/MediaCues', mediaCue, { headers })
        .pipe(
          tap((_) => this.log(`posted MediaCue id=${mediaCue.id}`)),
          catchError(
            this.handleError<IMediaCue>(`saveMediaCue id=${mediaCue.id}`),
          ),
        );
  ...
  setMediaCueContentType(
    mediaCue: IMediaCue,
    contentType: string,
    subType: string,
  ): Observable<IMediaCue> {
    const headers = new HttpHeaders().set('content-type', 'application/json');
    ...
    return this.http
      ...
      .pipe(
        ...
        catchError(
          this.handleError<IMediaCue>(
            `setMediaCueContentType id=${mediaCue.id}`,
          ),
        ),
      );
  }
  ...
  getLearningPrograms(): Observable<ILearningProgram[]> {
    return this.http.get<ILearningProgram[]>('/api/LearningPrograms').pipe(
      tap((_) => this.log('fetched LearningPrograms')),
      catchError(
        this.handleError<ILearningProgram[]>('getLearningPrograms', []),
      ),
    );
  }

  getLearningProgramsByOrganizationId(
    orgId: number,
  ): Observable<ILearningProgram[]> {
    return this.http
      .get<
        ILearningProgram[]
      >('/api/LearningPrograms/byOrganizationId/' + orgId)
      .pipe(
        tap((_) =>
          this.log('fetched LearningPrograms for OrgId ' + orgId.toString()),
        ),
        catchError(
          this.handleError<ILearningProgram[]>(
            'getLearningProgramsByOrganizationId',
            [],
          ),
        ),
  ...
  getLearningProgramsWithModules(
    orgId: number,
  ): Observable<ILearningProgram[]> {
    return this.http
      .get<ILearningProgram[]>('/api/LearningPrograms/withModules')
      .pipe(
        tap((_) =>
          this.log(
            'fetched LearningPrograms with Modules for OrgId ' +
              orgId.toString(),
          ),
        ),
        catchError(
  ...
  getLearningProgram(id: number): Observable<ILearningProgram> {
    return this.http.get<ILearningProgram>('/api/LearningPrograms/' + id).pipe(
      tap((_) => this.log(`fetched LearingProgram id=${id}`)),
      catchError(
        this.handleError<ILearningProgram>(`getLearningProgram id=${id}`),
      ),
    );
  }
  ...
  getProgramDependencies(id: number): Observable<any> {
    return this.http
      .get<any[]>('/api/LearningPrograms/Dependencies/' + id)
      .pipe(
  ...
  deleteLearningProgram(id: number): Observable<any> {
    return this.http
      .delete<ILearningProgram>('/api/LearningPrograms/' + id)
      .pipe(
        tap((_) => this.log(`deleted LearingProgram id=${id}`)),
        catchError(
          this.handleError<ILearningProgram>(`deleteLearningProgram id=${id}`),
        ),
      );
  }
  ...
  saveLearningProgram(
    ...
    if (learningProgram.id > 0) {
      return this.http
        .put<ILearningProgram>(
          '/api/LearningPrograms/' + learningProgram.id,
          learningProgram,
          { headers },
        )
        .pipe(
          ...
          catchError(
            this.handleError<ILearningProgram>(
              `saveLearningProgram id=${learningProgram.id}`,
            ),
          ),
        );
    } else {
      return this.http
        .post<ILearningProgram>('/api/LearningPrograms', learningProgram, {
          headers,
        })
        .pipe(
          tap((_) =>
            this.log(`posted LearingProgram id=${learningProgram.id}`),
          ),
          catchError(
            this.handleError<ILearningProgram>(
              `saveLearningProgram id=${learningProgram.id}`,
  ...
  getModules(): Observable<IModule[]> {
    return this.http.get<IModule[]>('/api/Modules').pipe(
  ...
  getModulesByOrganizationId(orgId: number): Observable<IModule[]> {
    return this.http
      .get<IModule[]>('/api/Modules/byOrganizationId/' + orgId)
      .pipe(
        tap((_) => this.log('fetched Modules for OrgId: ' + orgId)),
        catchError(
          this.handleError<IModule[]>('getModulesByOrganizationId', []),
        ),
      );
  }

  getModulesByProgramId(id: number): Observable<IModule[]> {
    return this.http.get<IModule[]>('/api/Modules/byProgramId/' + id).pipe(
  ...
  getModule(id: number): Observable<IModule> {
    return this.http.get<IModule>('/api/Modules/' + id).pipe(
  ...
  getModuleByName(name: string): Observable<IModule> {
    return this.http.get<IModule>('/api/Modules/ByName/' + name).pipe(
  ...
  getModuleDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/Modules/Dependencies/' + id).pipe(
  ...
  deleteModule(id: number): Observable<any> {
    return this.http.delete<IModule>('/api/Modules/' + id).pipe(
  ...
  saveModule(module: IModule): Observable<IModule> {
    ...
    if (module.id > 0) {
      return this.http
        .put<IModule>('/api/Modules/' + module.id, module, { headers })
        .pipe(
  ...
  getRatingSystems(): Observable<IRatingSystem[]> {
    return this.http.get<IRatingSystem[]>('/api/RatingSystems').pipe(
  ...
  getRatingSystem(id: number): Observable<IRatingSystem> {
    return this.http.get<IRatingSystem>('/api/RatingSystems/' + id).pipe(
  ...
  getRatingSystemByOrganizationId(orgId: number): Observable<IRatingSystem[]> {
    return this.http
      .get<IRatingSystem[]>('/api/RatingSystems/byOrganizationId/' + orgId)
      .pipe(
        tap((_) => this.log(`fetched Rating Systems orgId=${orgId}`)),
        catchError(
          this.handleError<IRatingSystem[]>(
            `getRatingSystemByOrganizationId orgId=${orgId}`,
          ),
        ),
      );
  }

  getRatingSystemDependencies(
    id: number,
  ): Observable<IRatingSystemDependencies> {
    return this.http
      .get<IRatingSystemDependencies>('/api/RatingSystems/Dependencies/' + id)
      .pipe(
        tap((_) => this.log(`fetched rating system dependencies for id=${id}`)),
        catchError(
          this.handleError<IRatingSystemDependencies>(
            `getRatingSystemDependencies id=${id}`,
          ),
        ),
      );
  }
  ...
  deleteRatingSystem(id: number): Observable<any> {
    return this.http.delete<IRatingSystem>('/api/RatingSystems/' + id).pipe(
      tap((_) => this.log(`deleted Rating System id=${id}`)),
      catchError(
        this.handleError<IRatingSystem>(`deleteRatingSystem id=${id}`),
      ),
    );
  }
  ...
  saveRatingSystem(ratingSystem: IRatingSystem): Observable<IRatingSystem> {
    ...
    if (ratingSystem.id > 0) {
      return this.http
        .put<IRatingSystem>(
          '/api/RatingSystems/' + ratingSystem.id,
          ratingSystem,
          { headers },
        )
        .pipe(
          ...
          catchError(
            this.handleError<IRatingSystem>(
              `saveRatingSystem id=${ratingSystem.id}`,
            ),
          ),
        );
    } else {
      return this.http
        .post<IRatingSystem>('/api/RatingSystems', ratingSystem, { headers })
        .pipe(
  ...
  getRatingSystemValues(): Observable<IRatingSystemValue[]> {
    return this.http.get<IRatingSystemValue[]>('/api/RatingSystemValues').pipe(
      tap((_) => this.log('fetched RatingSystemValues')),
      catchError(
        this.handleError<IRatingSystemValue[]>('getRatingSystemValues', []),
      ),
    );
  }

  getRatingSystemValuesByRatingSystemId(
    id: number,
  ): Observable<IRatingSystemValue[]> {
    return this.http
      .get<
        IRatingSystemValue[]
      >('/api/RatingSystemValues/byRatingSystemId/' + id)
      .pipe(
        tap((_) =>
          this.log('fetched RatingSystemValues for RatingSystemId: ' + id),
        ),
        catchError(
          this.handleError<IRatingSystemValue[]>(
            'getRatingSystemValuesByRatingSystemId',
            [],
          ),
        ),
  ...
  getRatingSystemValue(id: number): Observable<IRatingSystemValue> {
    return this.http
      .get<IRatingSystemValue>('/api/RatingSystemValues/' + id)
      .pipe(
        tap((_) => this.log(`fetched RatingSystemValue id=${id}`)),
        catchError(
          this.handleError<IRatingSystemValue>(`getRatingSystemValue id=${id}`),
        ),
      );
  }

  getRatingSystemValueDependencies(
    id: number,
  ): Observable<IRatingSystemValueDependencies> {
    return this.http
      .get<IRatingSystemValueDependencies>(
        '/api/RatingSystemValues/Dependencies/' + id,
      )
      .pipe(
        tap((_) => this.log(`fetched RatingSystemValueDependencies id=${id}`)),
        catchError(
          this.handleError<IRatingSystemValueDependencies>(
            `getRatingSystemValueDependencies id=${id}`,
          ),
        ),
      );
  }
  ...
  deleteRatingSystemValue(id: number): Observable<any> {
    return this.http
      .delete<IRatingSystemValue>('/api/RatingSystemValues/' + id)
      .pipe(
        tap((_) => this.log(`deleted RatingSystemValue id=${id}`)),
        catchError(
          this.handleError<IRatingSystemValue>(
            `deleteRatingSystemValue id=${id}`,
          ),
        ),
      );
  }

  saveRatingSystemValue(
    rsv: IRatingSystemValue,
  ): Observable<IRatingSystemValue> {
    const headers = new HttpHeaders().set('content-type', 'application/json');

    if (rsv.id > 0) {
      return this.http
        .put<IRatingSystemValue>('/api/RatingSystemValues/' + rsv.id, rsv, {
          headers,
        })
        .pipe(
          ...
          catchError(
            this.handleError<IRatingSystemValue>(
              `saveRatingSystemValue id=${rsv.id}`,
            ),
          ),
        );
    } else {
      return this.http
        .post<IRatingSystemValue>('/api/RatingSystemValues', rsv, { headers })
        .pipe(
  ...
  getTasks(): Observable<ITaskRow[]> {
    return this.http.get<ITaskRow[]>('/api/Tasks').pipe(
  ...
  getTasksByOrganizationId(orgId: number): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/byOrganizationId/' + orgId)
      .pipe(
        tap((_) => this.log('fetched Tasks for OrgId: ' + orgId)),
        catchError(
          this.handleError<ITaskRow[]>('getTasksByOrganizationId', []),
        ),
      );
  }
  ...
  getTasksByOrganizationIdPublished(orgId: number): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/byOrganizationIdPublished/' + orgId)
      .pipe(
        tap((_) => this.log('fetched published Tasks for OrgId: ' + orgId)),
        catchError(
          this.handleError<ITaskRow[]>('getTasksByOrganizationIdPublished', []),
        ),
      );
  }
  ...
  getUnitCountTasksForTraineeId(traineeId: string): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/UnitCountTasksForTrainee/' + traineeId)
      .pipe(
        tap((_) =>
          this.log('fetched Unit Count Tasks for traineeId: ' + traineeId),
        ),
        catchError(
          this.handleError<ITaskRow[]>('getUnitCountTasksForTraineeId', []),
        ),
      );
  }

  getTasksByModuleId(id: number): Observable<ITaskRow[]> {
    return this.http.get<ITaskRow[]>('/api/Tasks/byModuleId/' + id).pipe(
  ...
  getTasksByModuleIPublished(id: number): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/byModuleIdPublished/' + id)
      .pipe(
        tap((_) => this.log('fetched published Tasks for ModuleId: ' + id)),
        catchError(
          this.handleError<ITaskRow[]>('getTasksByModuleIdPublished', []),
        ),
      );
  }
  ...
  getEvaluationTasksForTrainer(traineeId: string): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/EvaluationTasksForTrainerId/' + traineeId)
      .pipe(
        tap((_) =>
          this.log('fetched Evaluation Tasks for trainerId: ' + traineeId),
        ),
        catchError(
          this.handleError<ITaskRow[]>('getEvaluationTasksForTrainer', []),
        ),
      );
  }

  getSubTasksByOrgId(id: number): Observable<ITaskRow[]> {
    return this.http.get<ITaskRow[]>('/api/Tasks/subTasks/' + id).pipe(
  ...
  getSubTasksByTaskStepId(id: number): Observable<ITaskRow[]> {
    return this.http
      .get<ITaskRow[]>('/api/Tasks/subTasksByTaskStepId/' + id)
      .pipe(
  ...
  getTasksAssignedToUser(id: string): Observable<ITaskRow[]> {
    return this.http.get<ITaskRow[]>('/api/Tasks/assignedToUser/' + id).pipe(
  ...
  getTaskRow(id: number): Observable<ITaskRow> {
    return this.http.get<ITaskRow>('/api/Tasks/taskRow/' + id).pipe(
  ...
  getTaskStepsWithSubTasks(id: number): Observable<IIdName[]> {
    return this.http
      .get<IIdName[]>('/api/Tasks/' + id + '/stepsWithSubTasks')
      .pipe(
        tap((_) => this.log(`fetched Task Steps with SubTasks id=${id}`)),
        catchError(
          this.handleError<IIdName[]>(`getTaskStepsWithSubTasks id=${id}`),
        ),
      );
  }
  ...
  getTaskSubTasks(id: number): Observable<ITaskStepSubTaskRow[]> {
    return this.http
      .get<ITaskStepSubTaskRow[]>('/api/Tasks/' + id + '/subTasks')
      .pipe(
        tap((_) => this.log(`fetched Task SubTasks id=${id}`)),
        catchError(
          this.handleError<ITaskStepSubTaskRow[]>(`getTaskSubTasks id=${id}`),
        ),
      );
  }

  getTaskDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/Tasks/Dependencies/' + id).pipe(
  ...
  deleteTask(id: number): Observable<any> {
    return this.http.delete<ITask>('/api/Tasks/' + id).pipe(
  ...
  saveTask(task: ITask): Observable<ITask> {
    ...
    if (task.id > 0) {
      return this.http
        .put<ITask>('/api/Tasks/' + task.id, task, { headers })
        .pipe(
  ...
  createNewTaskVersion(id: number, versionNumber: number) {
    ...
    return this.http
      .put<ITask>(
        '/api/Tasks/newTaskVersion/' + id + '/' + versionNumber,
        'createNewTaskVersion',
        { headers },
      )
      .pipe(
        tap((_) =>
          this.log(`createNewTaskVersion id=${id} version=${versionNumber}`),
        ),
        catchError(
          this.handleError<ITask>(
            `createNewTaskVersion id=${id} version=${versionNumber}`,
          ),
        ),
      );
  }
  ...
  publishTaskVersion(id: number, versionNumber: number) {
    ...
    return this.http
      .put<ITask>(
        '/api/Tasks/publishTaskVersion/' + id + '/' + versionNumber,
        'publishTaskVersion',
        { headers },
      )
      .pipe(
        tap((_) =>
          this.log(`publishTaskVersion id=${id} version=${versionNumber}`),
        ),
        catchError(
          this.handleError<ITask>(
            `publishTaskVersion id=${id} version=${versionNumber}`,
          ),
        ),
      );
  }
  ...
  getTaskSteps(): Observable<ITaskStepRow[]> {
    return this.http.get<ITaskStepRow[]>('/api/TaskSteps').pipe(
  ...
  getTaskStepsByTaskId(id: number): Observable<ITaskStepRow[]> {
    return this.http.get<ITaskStepRow[]>('/api/TaskSteps/byTaskId/' + id).pipe(
      tap((_) => this.log('fetched TaskSteps for TaskId: ' + id)),
      catchError(this.handleError<ITaskStepRow[]>('getTaskStepsByTaskId', [])),
    );
  }

  getTaskStepsByTaskIdWithOverrides(
    taskId: number,
    userId: string,
    taskStepOverrides: ITaskStepSubTaskOverride[],
  ): Observable<ITaskTrainingInformation> {
    const headers = new HttpHeaders();
    headers.append('Content-Type', 'application/json');

    const taskWithOverrides: ITaskWithOverrides = {
      taskId: taskId,
      userId: userId,
      overrides: taskStepOverrides,
    };

    return this.http
      .post<ITaskTrainingInformation>(
        '/api/TaskSteps/withOverrides',
        taskWithOverrides,
        { headers },
      )
      .pipe(
        ...
        catchError(
          this.handleError<ITaskTrainingInformation>(
            `getTaskStepsByTaskIdWithOverrides id=${taskId}`,
          ),
        ),
      );
  }
  ...
  getTaskStep(id: number): Observable<ITaskStep> {
    return this.http.get<ITaskStep>('/api/TaskSteps/' + id).pipe(
  ...
  getTaskStepRow(id: number): Observable<ITaskStepRow> {
    return this.http.get<ITaskStepRow>('/api/TaskSteps/taskRow/' + id).pipe(
  ...
  getTaskStepInfo(id: number): Observable<ITaskStepInfo> {
    return this.http
      .get<ITaskStepInfo>('/api/TaskSteps/taskStepInfo/' + id)
      .pipe(
  ...
  getTaskStepDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/TaskSteps/Dependencies/' + id).pipe(
  ...
  deleteTaskStep(id: number): Observable<any> {
    return this.http.delete<ITaskStep>('/api/TaskSteps/' + id).pipe(
  ...
  deleteTaskStepSubTask(id: number, subTaskId: number): Observable<any> {
    return this.http
      .delete<ITaskStep>('/api/TaskSteps/' + id + '/subTask/' + subTaskId)
      .pipe(
        tap((_) =>
          this.log(`deleted TaskStep SubTask id=${id}, subId=${subTaskId}`),
        ),
        catchError(
          this.handleError<ITaskStep>(`deleteTaskStepSubTask id=${id}`),
        ),
      );
  }
  ...
  saveTaskStep(taskStep: ITaskStep): Observable<ITaskStep> {
    ...
    if (taskStep.id > 0) {
      return this.http
        .put<ITaskStep>('/api/TaskSteps/' + taskStep.id, taskStep, { headers })
        .pipe(
          tap((_) => this.log(`put TaskStep id=${taskStep.id}`)),
          catchError(
            this.handleError<ITaskStep>(`saveTaskStep id=${taskStep.id}`),
          ),
        );
    } else {
      return this.http
        .post<ITaskStep>('/api/TaskSteps', taskStep, { headers })
        .pipe(
  ...
  saveTaskStepReorder(taskStepRows: ITaskStepRow[]): Observable<ITaskStepRow> {
    ...
    return this.http
      .put<ITaskStepRow>('/api/TaskSteps/TaskStepRows', taskStepRows, {
        headers,
      })
      .pipe(
  ...
  saveTaskStepSubTasks(
    assignment: ITaskStepSubTaskAssignment,
  ): Observable<ITaskStepSubTaskAssignment> {
    const headers = new HttpHeaders().set('content-type', 'application/json');

    return this.http
      .put<ITaskStepSubTaskAssignment>(
        '/api/TaskSteps/' + assignment.taskStepId + '/assignSubTasks',
        assignment,
        { headers },
      )
      .pipe(
        tap((_) =>
          this.log(`put TaskStepSubTaskAssignment id=${assignment.taskStepId}`),
        ),
        catchError(
          this.handleError<ITaskStepSubTaskAssignment>(
            `saveTaskStepSubTasks id=${assignment.taskStepId}`,
          ),
        ),
      );
  }
  ...
  getClassrooms(): Observable<IClassroom[]> {
    return this.http.get<IClassroom[]>('/api/Classrooms').pipe(
      tap((_) => this.log('fetched Classrooms')),
      catchError(this.handleError<IClassroom[]>('getClassRooms', [])),
    );
  }

  getClassroomsByOrganizationId(
    organizationId: number,
  ): Observable<IClassroom[]> {
    return this.http
      .get<IClassroom[]>('/api/Classrooms/ByOrganizationId/' + organizationId)
      .pipe(
        tap((_) =>
          this.log(`fetched Classrooms by Organization  id=${organizationId}`),
        ),
        catchError(this.handleError<IClassroom[]>('getClassRooms', [])),
      );
  }
  ...
  getClassroom(id: number): Observable<IClassroom> {
    return this.http.get<IClassroom>('/api/Classrooms/' + id).pipe(
  ...
  getClassroomDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/Classrooms/Dependencies/' + id).pipe(
      tap((_) => this.log('fetched Dependencies for ProgramId: ' + id)),
  ...
  deleteClassroom(id: number): Observable<any> {
    return this.http.delete<IClassroom>('/api/Classrooms/' + id).pipe(
  ...
  saveClassroom(classroom: IClassroom): Observable<IClassroom> {
    ...
    if (classroom.id > 0) {
      return this.http
        .put<IClassroom>('/api/Classrooms/' + classroom.id, classroom, {
          headers,
        })
        .pipe(
          tap((_) => this.log(`put Classroom id=${classroom.id}`)),
          catchError(
            this.handleError<IClassroom>(`saveClassroom id=${classroom.id}`),
          ),
        );
    } else {
      return this.http
        .post<IClassroom>('/api/Classrooms', classroom, { headers })
        .pipe(
  ...
  getTaskItems(): Observable<ITaskItem[]> {
    return this.http.get<ITaskItem[]>('/api/TaskItems').pipe(
      tap((_) => this.log('fetched TaskItems')),
      catchError(this.handleError<ITaskItem[]>('getTaskITems', [])),
    );
  }

  getTaskItemsByOrganizationId(
    organizationId: number,
  ): Observable<ITaskItem[]> {
    return this.http
      .get<ITaskItem[]>('/api/TaskItems/ByOrganizationId/' + organizationId)
      .pipe(
        tap((_) => this.log('fetched TaskItems')),
        catchError(this.handleError<ITaskItem[]>('getTaskITems', [])),
      );
  ...
  GetTaskItem(id: number): Observable<ITaskItem> {
    return this.http.get<ITaskItem>('/api/TaskItems/' + id).pipe(
  ...
  getTaskItemDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/TaskItems/Dependencies/' + id).pipe(
      tap((_) => this.log('fetched Dependencies for TaskItem id=${id}')),
      catchError(
        this.handleError<any[]>('getTaskItemDependencies id=${id}', []),
      ),
    );
  }

  deleteTaskItem(id: number): Observable<any> {
    return this.http.delete<ITaskItem>('/api/TaskItems/' + id).pipe(
  ...
  saveTaskItem(taskItem: ITaskItem): Observable<ITaskItem> {
    ...
    if (taskItem.id > 0) {
      return this.http
        .put<ITaskItem>('/api/TaskItems/' + taskItem.id, taskItem, { headers })
        .pipe(
          tap((_) => this.log(`put TaskItem id=${taskItem.id}`)),
          catchError(
            this.handleError<ITaskItem>(`saveTaskItem id=${taskItem.id}`),
          ),
        );
    } else {
      return this.http
        .post<ITaskItem>('/api/TaskITems', taskItem, { headers })
        .pipe(
  ...
  getTaskUserOverrides(
    taskId: number,
    userId: string,
  ): Observable<ITaskUserOverrideSet> {
    return this.http
      .get<ITaskUserOverrideSet>('/api/Override/' + taskId + '/' + userId)
      .pipe(
        tap((_) =>
          this.log(`get TaskUserOverrides taskId=${taskId} userId=${userId}`),
        ),
        catchError(
          this.handleError<ITaskUserOverrideSet>(
            `error in TaskUserOverrides taskId=${taskId} userId=${userId}`,
          ),
        ),
      );
  }
  ...
  getTaskUserOverridesById(id: number): Observable<ITaskUserOverrideSet> {
    return this.http.get<ITaskUserOverrideSet>('/api/Override/byId/' + id).pipe(
      tap((_) => this.log(`get TaskUserOverridesById id=${id}`)),
      catchError(
        this.handleError<ITaskUserOverrideSet>(
          `error in TaskUserOverridesById id=${id}`,
        ),
      ),
    );
  }

  saveTaskUserOverrideSet(
    os: ITaskUserOverrideSet,
  ): Observable<ITaskUserOverrideSet> {
    const headers = new HttpHeaders().set('content-type', 'application/json');

    return this.http
      .post<ITaskUserOverrideSet>('/api/Override/overrideSet', os, { headers })
      .pipe(
        tap((_) =>
          this.log(`posted OverrideSeet num=${os.taskUserOverrides.length}`),
        ),
        catchError(
          this.handleError<ITaskUserOverrideSet>(
            `saveOverrideSet num=${os.taskUserOverrides.length}`,
          ),
        ),
      );
  }

  deleteOverridesForTaskUser(
    taskId: number,
    userId: string,
  ): Observable<IDeleteResult> {
    return this.http
      .delete<IDeleteResult>('/api/Override/' + taskId + '/' + userId)
      .pipe(
        tap((_) =>
          this.log(`deleted Overrides taskId=${taskId} userId=${userId}`),
        ),
        catchError(
          this.handleDeleteError(
            `deleteOverridesForTaskUser taskId=${taskId} userId=${userId}`,
          ),
        ),
      );
  }
  ...
  getProblemTypes(): Observable<IProblemType[]> {
    return this.http.get<IProblemType[]>('/api/ProblemTypes').pipe(
  ...
  GetProblemType(id: number): Observable<IProblemType> {
    return this.http.get<IProblemType>('/api/ProblemTypes/' + id).pipe(
  ...
  getProblemTypeDependencies(id: number): Observable<any> {
    return this.http.get<any[]>('/api/ProblemTypes/Dependencies/' + id).pipe(
      tap((_) => this.log('fetched Dependencies for ProblemType id=${id}')),
      catchError(
        this.handleError<any[]>('getProblemTypeDependencies id=${id}', []),
      ),
    );
  }
  ...
  getMediaProperties(): Observable<ContentServiceModels.IMediaProperties> {
    return this.http
      .get<ContentServiceModels.IMediaProperties>(
        '/api/MediaCues/MediaProperties',
      )
      .pipe(
        tap((_) => this.log('fetched Media Properties.')),
        catchError(
          this.handleError<ContentServiceModels.IMediaProperties>(
            'GetMediaProperties',
          ),
        ),
      );
  ...
  deleteProblemType(id: number): Observable<any> {
    return this.http.delete<IProblemType>('/api/ProblemTypes/' + id).pipe(
  ...
  saveProblemType(problemType: IProblemType): Observable<IProblemType> {
    ...
    if (problemType.id > 0) {
      return this.http
        .put<IProblemType>('/api/ProblemTypes/' + problemType.id, problemType, {
          headers,
        })
        .pipe(
          tap((_) => this.log(`put ProblemType id=${problemType.id}`)),
          catchError(
            this.handleError<IProblemType>(
              `saveProblemType id=${problemType.id}`,
            ),
          ),
        );
    } else {
      return this.http
        .post<IProblemType>('/api/ProblemTypes', problemType, { headers })
        .pipe(
  ...
  saveShareChangeSet(changes: IShareChangeSet): Observable<IShareChangeSet> {
    ...
    return this.http
      .put<IShareChangeSet>('/api/TaskSteps/ShareChangeSet/', changes, {
        headers,
      })
      .pipe(
